<native:scroll-view class="w-full h-full bg-gray-50">
    <native:column class="w-full items-center gap-4 p-6">
        ...
        <native:column class="w-full gap-3 mt-2">
            <native:outlined-text-input placeholder="Full name" native:model="name" class="w-full" />
            <native:outlined-text-input placeholder="Email" keyboard="email" native:model="email" class="w-full" />
            <native:outlined-text-input placeholder="Password" secure native:model="password" class="w-full" />
            <native:outlined-text-input placeholder="Phone (optional)" native:model="phone" class="w-full" />
            ...
            @if ($role === 'provider')
                ...
                <native:outlined-text-input placeholder="Vehicle info (e.g. Tow Truck - ABC-123)" native:model="vehicleInfo" class="w-full" />
